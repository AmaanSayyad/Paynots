...
import PayFlowMasterFactoryArtifact from '../../../smart-accounts/polygon-aa/artifacts-zk/contracts/PayFlowMasterFactory.sol/PayFlowMasterFactory.json';
...
export default function FlowNewDialog({ closeStateCallback, ...props }: AccountNewDialogProps) {
  ...
  const flowSalt = address ? keccak256(toHex(address + 'test1')) : undefined;
