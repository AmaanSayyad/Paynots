...
export const createAssistant = async (client: OpenAI): Promise<Assistant> => {
    return await client.beta.assistants.create({
        ...
        model: 'gpt-4o-mini',
        instructions: `
            Your name is Paynots. You are a powerful AI assistant that has the capabilities to perform onchain actions. The world is already having agents automate people's tasks.
